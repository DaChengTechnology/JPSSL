# jpssl — C++11+ 高性能密码学库（CPU + MUSA GPU，MSVC 最低 C++14）
...
- [快速开始](#快速开始)
- [Windows 构建（MSVC）](#windows-构建msvc)
- [Android（arm64-v8a）实现](#androidarm64-v8a实现)
...
- [动态库 / 静态库](#动态库--静态库)
- [命令行工具](#命令行工具)
  - [jpssl-cert — 证书工具](#jpssl-cert--证书工具)
  - [jpssl-crypt — 加密/哈希工具](#jpssl-crypt--加密哈希工具)
- [算法总览](#算法总览)
- [API 示例](#api-示例)
  - [AES](#aes)
  - [ChaCha20-Poly1305](#chacha20-poly1305)
  - [RSA 2048 / 4096](#rsa-2048--4096)
  - [SHA-1 / SHA256 / SHA384/512 / SHA3 / HMAC / HKDF](#sha-1--sha256--sha384512--sha3--hmac--hkdf)
  - [SM2 签名/验证 (GM/T 0003)](#sm2-签名验证-gmt-0003)
  - [SM3 密码杂凑 (GM/T 0004)](#sm3-密码杂凑-gmt-0004)
  - [SM4 分组密码 (GM/T 0002)](#sm4-分组密码-gmt-0002)
  - [SM4-GCM AEAD](#sm4-gcm-aead)
...
- [GPU 持久化池](#gpu-持久化池)
- [性能 (MTT S80 + i7-13700K)](#性能-mtt-s80--i7-13700k)
- [文件结构](#文件结构)
- [条件编译](#条件编译)
- [依赖](#依赖)
