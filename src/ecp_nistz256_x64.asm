; ecp_nistz256_x64.asm - NIST P-256 nistz256 (OpenSSL 3.0, ADX) point arithmetic
; Generated by ecp_nistz256-x86_64.pl (masm flavour) with dummy table data.
; Only the code/constants are kept; the 151KB precomputed table is generated
; at runtime by jpssl (g_nistz_pre) instead.
OPTION DOTNAME


.rodata SEGMENT READONLY ALIGN(64)
ALIGN 8
PUBLIC OPENSSL_ia32cap_P
OPENSSL_ia32cap_P DQ 0, 0000000000080100h, 0, 0   ; BMI2+ADX -> ADX (x) paths
...
ALIGN	32
ecp_nistz256_ord_sqr_montx	PROC PUBLIC
	mov	QWORD PTR[8+rsp],rdi	;WIN64 prologue
	mov	QWORD PTR[16+rsp],rsi
	mov	rax,rsp
