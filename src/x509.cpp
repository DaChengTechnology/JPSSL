...
const uint8_t OID_PBES2[]     = {0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x05,0x0D};
const uint8_t OID_PBKDF2[]    = {0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x05,0x0C};
const uint8_t OID_HMAC_SHA256[] = {0x2A,0x86,0x48,0x86,0xF7,0x0D,0x02,0x09};
const uint8_t OID_AES128_CBC[] = {0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x01,0x02};
const uint8_t OID_AES256_CBC[] = {0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x01,0x2A};
